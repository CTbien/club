...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AbonnementsRepository' => ['privates', 'App\\Repository\\AbonnementsRepository', 'getAbonnementsRepositoryService', true],
            'App\\Repository\\ActivitesRepository' => ['privates', 'App\\Repository\\ActivitesRepository', 'getActivitesRepositoryService', true],
            'App\\Repository\\AdherentsRepository' => ['privates', 'App\\Repository\\AdherentsRepository', 'getAdherentsRepositoryService', true],
            ...
            'App\\Repository\\EquipementsRepository' => ['privates', 'App\\Repository\\EquipementsRepository', 'getEquipementsRepositoryService', true],
            'App\\Repository\\FactureRepository' => ['privates', 'App\\Repository\\FactureRepository', 'getFactureRepositoryService', true],
            'App\\Repository\\InscriptionsActiviteRepository' => ['privates', 'App\\Repository\\InscriptionsActiviteRepository', 'getInscriptionsActiviteRepositoryService', true],
            'App\\Repository\\SessionsRepository' => ['privates', 'App\\Repository\\SessionsRepository', 'getSessionsRepositoryService', true],
        ], [
            'App\\Repository\\AbonnementsRepository' => '?',
            'App\\Repository\\ActivitesRepository' => '?',
            'App\\Repository\\AdherentsRepository' => '?',
            'App\\Repository\\CoachRepository' => '?',
            'App\\Repository\\CompetitionRepository' => '?',
            'App\\Repository\\EquipementsRepository' => '?',
            'App\\Repository\\FactureRepository' => '?',
            'App\\Repository\\InscriptionsActiviteRepository' => '?',
